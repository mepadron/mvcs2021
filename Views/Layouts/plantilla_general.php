...
$pla = new PlantillGeneral();

class PlantillGeneral
{

    public function __construct()
    {
        ?>
        <!-- aqui todo el html q tiene con el top y aside -->
        <!DOCTYPE html>
<html lang="en">
...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
                ...
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="#" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
                            <i class="fa fa-wallet pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Payments2</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    {
        ?>
        <!-- aqui todo el html q tiene con footer -->
        <script>
